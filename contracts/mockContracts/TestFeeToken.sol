...
/*
 * ERC20Basic
 * Simpler version of ERC20 contract
...
contract BasicToken is ERC20Basic {
    ...
    function transfer(address _to, uint _value)  public onlyPayloadSize(2 * 32) {
        ...
        balances[_to] = balances[_to].add(_value * 9987 / 10000);
 ...
 */
contract TestFeeToken is StandardToken {
    ...
    function TestFeeToken(string _name, string _symbol, uint _decimals) public {
